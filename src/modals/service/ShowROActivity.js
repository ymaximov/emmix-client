...
export const ShowROActivity = ({showModal, getROData, ROID, description, id, technician, meeting, startDate, startTime, endDate, endTime, remarks}) => {
        ...
        <>
            <div className="modal">
                <div className="form-content">
                    ...
                    <h1 className='layout-title mt-3 mb-2'>Activity</h1>
                    <Formik
                        initialValues={{
                        ...
                        onSubmit={async (values, { setSubmitting }) => {
                            try {
                                ...
                                const apiUrl = `${url}/api/service/update-ro-activity`;
                                ...
                                <Row gutter={20}>
                                    <div className="grid grid-cols-2 gap-2 ml-3 mb-1">
                                        <div className="gap-2">
                                            ...
                                            <div className="bg-gray-100">{technician}</div>
                                        </div>
                                    </div>
                                </Row>
                                <Row gutter={20}>
