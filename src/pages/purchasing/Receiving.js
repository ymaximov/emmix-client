...
export const Receiving = () => {
    ...
    const goodsReceiptData = useSelector((state) => state.purchaseOrder).poDetails.goodsReceipt
            ...
            <div className="layout">
                ...
                <div className='mt-6'>
                    <div className="ag-theme-alpine" style={{ height: '20rem', width: '100%' }}>
                        <AgGridReact rowData={goodsReceiptData?.goods_receipt_items} columnDefs={columnDefs} onCellClicked={handleCellClicked}/>
                    </div>
                </div>
