        ...
        <>
            ...
            <div className="layout">
                ...
                <form onSubmit={getPurchaseOrderDataAndItems}> {/* Use a regular form with POST request */}
                    ...
                    <button type="submit" className={'mt-4 mb-3 ml-2 rounded-md bg-blue-400 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'}>Execute</button>
                </form>
            </div>
        </>
    );
